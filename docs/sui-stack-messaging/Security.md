...
6. For high-security use cases, consider implementing a custom Seal policy with additional access controls (for example, subscription-gated, NFT-gated, version-restricted). See the [Extending guide](./Extending.md) for examples.
