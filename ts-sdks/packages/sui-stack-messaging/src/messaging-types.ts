...
/** A decrypted message returned by {@link SuiStackMessagingClient} methods. */
...
/** Options for {@link SuiStackMessagingClient.sendMessage}. */
...
/** Options for {@link SuiStackMessagingClient.getMessage}. */
...
/** Options for {@link SuiStackMessagingClient.getMessages}. */
export type GetMessagesOptions<TApproveContext = void> = WithApproveContext<
	GetMessagesOptionsBase,
	TApproveContext
>;

/** Result of {@link SuiStackMessagingClient.getMessages}. */
...
/** Options for {@link SuiStackMessagingClient.editMessage}. */
export type EditMessageOptions<TApproveContext = void> = WithApproveContext<
	EditMessageOptionsBase,
	TApproveContext
>;

/** Options for {@link SuiStackMessagingClient.deleteMessage}. No encryption involved. */
...
/** Options for {@link SuiStackMessagingClient.subscribe}. */
...
/** Options for {@link SuiStackMessagingClient.recoverMessages}. */
