...
import type { GroupRef, SuiStackMessagingEncryptionOptions } from '../types.js';
import type { SuiStackMessagingView } from '../view.js';
...
export class EnvelopeEncryption<TApproveContext = void> {
	...
	readonly #view: SuiStackMessagingView;
	readonly #derive: SuiStackMessagingDerive;
