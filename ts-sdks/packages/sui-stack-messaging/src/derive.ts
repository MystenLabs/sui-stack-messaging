...
import type { GroupRef, SuiStackMessagingPackageConfig } from './types.js';

export interface SuiStackMessagingDeriveOptions {
 ...
 * ```
 */
export class SuiStackMessagingDerive {
	#packageConfig: SuiStackMessagingPackageConfig;

	constructor(options: SuiStackMessagingDeriveOptions) {
