...
import {
	...
	SuiNsAdmin,
	MetadataAdmin,
} from './contracts/sui_stack_messaging/messaging.js';
...
} from './contracts/sui_stack_messaging/encryption_history.js';

// Metadata module types
import { Metadata, MetadataKey } from './contracts/sui_stack_messaging/metadata.js';

// Actor object types
import { GroupManager } from './contracts/sui_stack_messaging/group_manager.js';
import { GroupLeaver } from './contracts/sui_stack_messaging/group_leaver.js';
...
export interface SuiStackMessagingBCSOptions {
 ...
 * @example
 * ```ts
 * const bcs = new SuiStackMessagingBCS({
 ...
 * ```
 */
export class SuiStackMessagingBCS {
	// === Messaging module types ===
	...
	constructor(options: SuiStackMessagingBCSOptions) {
