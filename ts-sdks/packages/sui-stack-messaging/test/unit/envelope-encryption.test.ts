...
import type { SuiStackMessagingView } from '../../src/view.js';
import { SuiStackMessagingDerive } from '../../src/derive.js';
...
function createMockView(currentKeyVersion = 0n): SuiStackMessagingView {
	return {
		getCurrentKeyVersion: async () => currentKeyVersion,
	} as unknown as SuiStackMessagingView;
}

function createMockDerive(): SuiStackMessagingDerive {
	return new SuiStackMessagingDerive({
		packageConfig: {
