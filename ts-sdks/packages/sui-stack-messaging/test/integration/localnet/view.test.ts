...
import { DefaultSealPolicy } from '@mysten/sui-stack-messaging';
...
describe('SuiStackMessagingView', () => {
	let client: SuiStackMessagingTestClient;
	...
	beforeAll(() => {
		...
		client = createSuiStackMessagingClient({
			url: suiClientUrl,
			network: 'localnet',
