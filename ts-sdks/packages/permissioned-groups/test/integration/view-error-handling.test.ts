...
import { PermissionedGroupsView } from '../../src/view.js';
import { createPermissionedGroupsClient } from '../helpers/index.js';
...
describe('PermissionedGroupsView error handling', () => {
