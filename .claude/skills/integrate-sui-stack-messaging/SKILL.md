...
| **2 — callback-based** | wallet integrations without a `Signer`, or when you wrap signs (e.g. to serialize them) | `encryption: { sessionKey: { address, onSign: async (msg) => signPersonalMessage(msg) } }` |
